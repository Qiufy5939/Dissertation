...
export  default  zero_data = [
    ...
    [{name: '彭山'}, {name: '眉山', value: 90}],    //22--24岁
    [{name: '眉山'}, {name: '成都', value: 90}],
    [{name: '成都'}, {name: '眉山', value: 90}],
    [{name: '彭山'}, {name: '彭山', value: 30}],
    [{name: '青神'}, {name: '眉山', value: 95}],    //24--27岁
    ...
    [{name: '周至'}, {name: '眉县', value: 95}],    //27--28岁
    ...
    [{name: '彭山'}, {name: '眉山', value: 70}],    //32--33岁
    [{name: '眉山'}, {name: '乐山', value: 90}],
    [{name: '乐山'}, {name: '宜宾', value: 80}],
    [{name: '宜宾'}, {name: '眉山', value: 70}],
    [{name: '成都'}, {name: '眉山', value: 95}],    //33--36岁
    ...
    [{name: '洛阳'}, {name: '开封', value: 95}],    //36--37岁
    ...
    [{name: '洛阳'}, {name: '洛阳', value: 30}],
    [{name: '余杭'}, {name: '海宁', value: 95}],    //37--38岁
    ...
    [{name: '富阳'}, {name: '杭州', value: 95}],    //38--39岁
    ...
    [{name: '临安'}, {name: '杭州', value: 70}],
    [{name: '海宁'}, {name: '杭州', value: 90}],    //39--43岁
    ...
    [{name: '萧县'}, {name: '徐州', value: 95}],    //43--44岁
    ...
    [{name: '湖州'}, {name: '吴江', value: 95}],    //44--45岁
    ...
    [{name: '黄冈'}, {name: '浠水', value: 35}],    //47--48岁
    ...
    [{name: '汉阳'}, {name: '汉阳', value: 30}],
    [{name: '商丘'}, {name: '宿州', value: 95}],    //50--54岁
    ...
    [{name: '嘉兴'}, {name: '杭州', value: 90}],    //54--56岁
    ...
    [{name: '商丘'}, {name: '开封', value: 95}],    //56--57岁
    [{name: '开封'}, {name: '淮阳', value: 90}],
    ...
    [{name: '睢县'}, {name: '临汝', value: 95}],    //59--62岁
    ...
    [{name: '睢县'}, {name: '睢县', value: 30}],
    [{name: '临高'}, {name: '儋州', value: 95}],    //62--65岁
    [{name: '儋州'}, {name: '琼山', value: 90}],
    [{name: '琼山'}, {name: '儋州', value: 80}],
    [{name: '临高'}, {name: '临高', value: 30}],
    [{name: '陵水'}, {name: '儋州', value: 95}],    //65--66岁
